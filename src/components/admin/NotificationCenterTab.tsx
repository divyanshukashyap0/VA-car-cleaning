...
const defaultTemplates: NotificationTemplate[] = [
  {
    ...
    description: "Your vehicle technician has been dispatched and is heading to your doorstep. Please ensure vehicle accessibility.",
    category: "Services",
    priority: "high",
    deepLink: "/account",
    isBuiltIn: true
  ...
  },
  {
    ...
    description: "Due to heavy rainfall in your area, outdoor service slots are being temporarily delayed for squad safety.",
    category: "Emergency",
    priority: "critical",
    deepLink: "/contact",
    isBuiltIn: true
  },
  {
    ...
    description: "Book any Premium Service session today and enjoy flat 15% discount using coupon code CLEAN15!",
    category: "Offers",
    priority: "normal",
