    ...
    <div className="pt-24 min-h-screen bg-[#F8FAFC] pb-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-5xl">
        ...
        <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">
          ...
          <span className="mx-2">/</span>
          <span className="text-primary">Interior Cleaning</span>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1601362840469-51e4d8d58785?auto=format&fit=crop&q=80&w=800"
                  alt="Dusty car console"
                  className="absolute inset-0 h-full object-cover filter saturate-[0.2] brightness-[0.5] contrast-[0.9] sepia-[0.3]"
